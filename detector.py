...
class Detector:
    ...
    def solve(self, img):
        ...
        cv.putText(img, 'rotX: %s' % round(rvecs[0][0], 3), (300, 50), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
        cv.putText(img, 'rotY: %s' % round(rvecs[1][0], 3), (300, 100), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
        cv.putText(img, 'rotZ: %s' % round(rvecs[2][0], 3), (300, 150), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
