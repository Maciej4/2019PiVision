...
class Camera(object):
    ...
    encoded_frame = None  # frame converted to jpeg
    ...
    def get_frame(self):
        ...
        return Camera.frame, Camera.encoded_frame
    ...
    def _thread(cls):
        ...
        for frame, encoded_frame  in frames_iterator:
            Camera.frame = frame
            Camera.encoded_frame = encoded_frame
